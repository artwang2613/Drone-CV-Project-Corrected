...
public class VirtualStickView extends RelativeLayout
    ...
    private void initUI() {
        ...
        btnOrbit = (ToggleButton) findViewById(R.id.btn_start_orbit);
